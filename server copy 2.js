...
app.post('/login', function (req, res) {
  ...
  const googleRecaptchaURL = `https://www.google.com/recaptcha/api/siteverify?secret=${secretKey}&response=${recaptchaResponse}`;

  axios.post(googleRecaptchaURL)
    .then(response => {
      if (response.data.success) {
        // reCAPTCHA verification successful, proceed with the login logic
